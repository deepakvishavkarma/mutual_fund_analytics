...
try:
    bench = pd.read_csv("C:/users/dell/mutual_fund_analytics/data/raw/10_benchmark_indices.csv")
    ...
    try:
        nifty = pd.read_csv("C:/users/dell/mutual_fund_analytics/data/raw/10_benchmark_indices.csv")
...
ab_df.to_csv("C:/users/dell/mutual_fund_analytics/data/processed/alpha_beta.csv", index=False)
