...
fig.write_html("c:/users/dell/mutual_fund_analytics/reports/charts/T3_sip_trend.html")
fig.write_image("c:/users/dell/mutual_fund_analytics/reports/charts/T3_sip_trend.png", width=1400, height=500)
print("✅ T3 saved")
